...
router.get("/api/getDocQuestionSets", cache(300), questionSetsController.get_doc_questionSets)
router.get("/api/getUserQuestionSets", cache(300), questionSetsController.get_user_questionSets)
//This api call fetches a question set
router.get("/api/fetchQS", cache(300), questionSetsController.fetch_QS)
