...
describe("Attach Document - container", () => {
  it("Attach Document to QS - container should exists", () => {
    const AttachDocumentToQSContainer = wrapper.find("[data-test-id='AttachDocumentToQS-container']")
...
describe("Attach Document - search bar", () => {
  it("Attach Document to QS should have a searchbar", () => {
    const AttachDocumentToQSSearchBar = wrapper.find("[data-test-id='AttachDocumentToQS-searchbar']")
