...
describe("QuestionSet - Card", () => {
  it("QuestionSet card container should exist", () => {
    const QuestionSetCardContainer = wrapper.find("[data-test-id='question-set-card-container']"); 
  ...
  it("Each questionSet card should have a side bar menu for adding different types of questions", () => {
    const QuestionSetCardSideBar = wrapper.find("[data-test-id='question-set-card-sideBar']");
